...
import leetcode.SimilarBST;

public class Similiar {
	
	public boolean ehSimiliar(BSTNode<Integer> root1, BSTNode<Integer> root2) {
	...
	public static void main(String[] args) {
		...
		SimilarBST<Integer> e = new SimilarBST<>();
		System.out.println(e.isSimiliar(n1, c1));
