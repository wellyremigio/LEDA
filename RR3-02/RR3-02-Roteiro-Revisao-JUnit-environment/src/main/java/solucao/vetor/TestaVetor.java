...
public class TestaVetor {
	...
	public void testInserir() {
		...
		vetorNaoVazio.inserir(new Aluno("Paulo", 5.0));
	...
	public void testRemover() {
		Aluno novoAluno = new Aluno("Tiago", 5.0);
	...
	public void testProcurar() {
		Aluno novoAluno = new Aluno("Adalberto", 5.0);
		vetorNaoVazio.inserir(novoAluno);

		Aluno procurado = vetorNaoVazio.procurar(novoAluno);
		assertEquals(novoAluno, procurado);
		procurado = vetorNaoVazio.procurar(new Aluno("Lívia", 6.0));
	...
	public void testIsCheio() {
		for (int i = 0; i < 10; i++) {
			Aluno novoAluno = new Aluno("Roberta", 5.0);
			vetorNaoVazio.inserir(novoAluno);
		}
	...
	public void testMaximo() {
		Aluno novoAluno1 = new Aluno("Hellen", 5.0);
		Aluno novoAluno2 = new Aluno("Patricia", 6.0);
	...
	public void testMinimo() {
		Aluno novoAluno1 = new Aluno("Robert", 5.0);
		Aluno novoAluno2 = new Aluno("Sheldon", 6.0);
		vetorNaoVazio.inserir(novoAluno1);
		vetorNaoVazio.inserir(novoAluno2);
